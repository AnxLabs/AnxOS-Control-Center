window.ANXOS_DOWNLOAD_CONFIG = {
  ...
  releaseLabel: "Version 2.0 Build 204 Private Alpha",
  releaseDate: "September 25, 2026",
  releaseTag: "v2.0-build204-rc4",
  releaseRepository: {
    owner: "AnxLabs",
    repo: "AnxOS-Control-Center-Releases",
  },
  repositoryUrl: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases",
  releaseUrl: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/tag/v2.0-build204-rc4",
  ...
  releaseAssets: [
      {
          fileName: "AnxOS-Control-Center-Setup-2.0-build204.exe",
          url: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/download/v2.0-build204-rc4/AnxOS-Control-Center-Setup-2.0-build204.exe"
      },
      {
          fileName: "AnxOS-Control-Center-2.0-build204-portable.exe",
          url: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/download/v2.0-build204-rc4/AnxOS-Control-Center-2.0-build204-portable.exe"
      },
      {
          fileName: "AnxOS-Control-Center-2.0-build204.AppImage",
          url: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/download/v2.0-build204-rc4/AnxOS-Control-Center-2.0-build204.AppImage"
      },
      {
          fileName: "AnxOS-Control-Center-2.0-build204.deb",
          url: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/download/v2.0-build204-rc4/AnxOS-Control-Center-2.0-build204.deb"
      }
  ],
  releaseNotes: [
      {
          ...
          "build": 204,
          "channel": "Private Alpha",
          "tag": "v2.0-build204-rc4",
          "date": "September 25, 2026",
          "datetime": "2026-09-25",
          "title": "AnxOS Control Center v2.0 — Build 204",
          "summary": "Build 204 is a Private Alpha channel release focused on first-run reliability, safer networking defaults, and stronger recovery safeguards. New installs are guided from download to first server, the Agent stays local to this computer unless you opt in, and the status you see matches what the app is ",
          "changes": [
          ...
          "url": "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/tag/v2.0-build204-rc4"
      },
      {
          "version": "2.0",
          "build": 203,
          "channel": "Private Alpha",
          "tag": "v1.9-build203-rc2",
          "date": "September 17, 2026",
          "datetime": "2026-09-17",
          "title": "Release Notes — AnxOS Control Center v2.0 build 203",
          "summary": "Build 203 ships the V2-A Wave-1 close-out, the first V2-C and V2-D slices,",
          "changes": [
              ...
              "Marketplace templates carry opt-in `version stamps`, `checksum`",
          ...
          "url": "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/tag/v1.9-build203-rc2"
      },
      {
          "version": "1.9",
          "build": 202,
          "channel": "Private Alpha",
          "tag": "v1.9-build202-rc1",
          "date": "September 16, 2026",
          "datetime": "2026-09-16",
          "title": "Release Notes — AnxOS Control Center v1.9 build 202",
          "summary": "Build 202 completes the UX/quality half of the original bug batch whose",
          "changes": [
          ...
          "url": "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/tag/v1.9-build202-rc1"
      },
      {
          "version": "1.9",
          "build": 201,
          ...
          "date": "September 16, 2026",
          "datetime": "2026-09-16",
          "title": "Release Notes — AnxOS Control Center v1.9 build 201",
          "summary": "Build 201 ships the crash-only bugfix batch on top of the Build 200 V2",
          "changes": [
      ...
      },
      {
          ...
          "datetime": "2026-09-16",
          "title": "Release Notes — AnxOS Control Center v1.9 build 200",
          "summary": "Build 200 establishes the V2 Reliability Contract without beginning the wider",
          "changes": [
