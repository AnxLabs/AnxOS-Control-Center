window.ANXOS_DOWNLOAD_CONFIG = {
  ...
  releaseLabel: "Version 1.9 Build 202 Private Alpha",
  releaseDate: "September 16, 2026",
  releaseTag: "v1.9-build202-rc1",
  releaseRepository: {
    owner: "AnxLabs",
    repo: "AnxOS-Control-Center-Releases",
  },
  repositoryUrl: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases",
  releaseUrl: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/tag/v1.9-build202-rc1",
  ...
  releaseAssets: [
      {
          fileName: "AnxOS-Control-Center-Setup-1.9-build202.exe",
          url: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/download/v1.9-build202-rc1/AnxOS-Control-Center-Setup-1.9-build202.exe"
      },
      {
          fileName: "AnxOS-Control-Center-1.9-build202-portable.exe",
          url: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/download/v1.9-build202-rc1/AnxOS-Control-Center-1.9-build202-portable.exe"
      },
      {
          fileName: "AnxOS-Control-Center-1.9-build202.AppImage",
          url: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/download/v1.9-build202-rc1/AnxOS-Control-Center-1.9-build202.AppImage"
      },
      {
          fileName: "AnxOS-Control-Center-1.9-build202.deb",
          url: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/download/v1.9-build202-rc1/AnxOS-Control-Center-1.9-build202.deb"
      }
  ],
  releaseNotes: [
      {
