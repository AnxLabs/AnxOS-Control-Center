window.ANXOS_DOWNLOAD_CONFIG = {
  ...
  releaseUrl: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/tag/v1.9-build199",
  ...
  releaseAssets: [
      {
          ...
          url: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/download/v1.9-build199/AnxOS-Control-Center-Setup-1.9-build199.exe"
      },
      {
          fileName: "AnxOS-Control-Center-1.9-build199-portable.exe",
          url: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/download/v1.9-build199/AnxOS-Control-Center-1.9-build199-portable.exe"
      },
      {
          fileName: "AnxOS-Control-Center-1.9-build199.AppImage",
          url: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/download/v1.9-build199/AnxOS-Control-Center-1.9-build199.AppImage"
      },
      {
          fileName: "AnxOS-Control-Center-1.9-build199.deb",
          url: "https://github.com/AnxLabs/AnxOS-Control-Center-Releases/releases/download/v1.9-build199/AnxOS-Control-Center-1.9-build199.deb"
      }
  ],
  releaseNotes: [
    {
