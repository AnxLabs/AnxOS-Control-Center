window.ANXOS_DOWNLOAD_CONFIG = {
  ...
  releaseLabel: "Version 1.9 Build 198 Private Alpha",
  releaseDate: "September 4, 2026",
  releaseTag: "v1.9-build198",
  releaseRepository: {
    owner: "bungopam-byte",
    repo: "AnxOS-Control-Center-Releases",
  },
  repositoryUrl: "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases",
  releaseUrl: "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/tag/v1.9-build198",
  ...
  releaseAssets: [
      {
          fileName: "AnxOS-Control-Center-Setup-1.9-build198.exe",
          url: "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/download/v1.9-build198/AnxOS-Control-Center-Setup-1.9-build198.exe"
      },
      {
          fileName: "AnxOS-Control-Center-1.9-build198-portable.exe",
          url: "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/download/v1.9-build198/AnxOS-Control-Center-1.9-build198-portable.exe"
      },
      {
          fileName: "AnxOS-Control-Center-1.9-build198.AppImage",
          url: "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/download/v1.9-build198/AnxOS-Control-Center-1.9-build198.AppImage"
      },
      {
          fileName: "AnxOS-Control-Center-1.9-build198.deb",
          url: "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/download/v1.9-build198/AnxOS-Control-Center-1.9-build198.deb"
      }
  ],
  releaseNotes: [
      {
