window.ANXOS_DOWNLOAD_CONFIG = {
  ...
  releaseLabel: "Version 1.9 Build 199 Private Alpha",
  releaseDate: "September 4, 2026",
  releaseTag: "v1.9-build199",
  releaseRepository: {
    owner: "bungopam-byte",
    repo: "AnxOS-Control-Center-Releases",
  },
  repositoryUrl: "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases",
  releaseUrl: "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/tag/v1.9-build199",
  ...
  releaseAssets: [
      {
          fileName: "AnxOS-Control-Center-Setup-1.9-build199.exe",
          url: "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/download/v1.9-build199/AnxOS-Control-Center-Setup-1.9-build199.exe"
      },
      {
          fileName: "AnxOS-Control-Center-1.9-build199-portable.exe",
          url: "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/download/v1.9-build199/AnxOS-Control-Center-1.9-build199-portable.exe"
      },
      {
          fileName: "AnxOS-Control-Center-1.9-build199.AppImage",
          url: "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/download/v1.9-build199/AnxOS-Control-Center-1.9-build199.AppImage"
      },
      {
          fileName: "AnxOS-Control-Center-1.9-build199.deb",
          url: "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/download/v1.9-build199/AnxOS-Control-Center-1.9-build199.deb"
      }
  ],
  releaseNotes: [
      {
          ...
          "url": "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/tag/v1.9-build199"
      },
      {
          "version": "1.9",
          "build": 198,
          ...
          "url": "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/tag/v1.9-build198"
      },
      {
          "version": "1.9",
          "build": 196,
      ...
      },
      {
          ...
          "url": "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/tag/v1.9-build193"
      },
      {
          "version": "1.9",
          "build": 192,
          ...
          "url": "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/tag/v1.9-build192"
      },
      {
          "version": "1.9",
          "build": 191,
      ...
      },
      {
          ...
          "url": "https://github.com/bungopam-byte/AnxOS-Control-Center-Releases/releases/tag/v1.8-build180"
      },
      {
          "version": "1.7",
          "build": 160,
