# Release Notes — AnxOS Control Center v2.0 build 205 (release candidate v2.0-build205-rc1)
...
`v2.0-build205-rc1`. The product identity is Build 205 of AnxOS Control Center
...
- The CI/release wiring that builds and attaches the Agent `.deb` is present
  ...
  `v2.0-build205-rc1` build; it does not publish a stable release.
