...
const PRIVATE_PATH_PREFIX_SOURCE = String.raw`(?:[A-Za-z]:\\Users\\|\/(?:(?:home|Users|root|srv|opt)\/|var\/(?:lib|log)\/))`;
const PRIVATE_PATH_BOUNDARY_SOURCE = String.raw`(^|[\s"'=(,:[{])`;
...
function redactString(value) {
  return String(value)
    ...
    .replace(DOUBLE_QUOTED_PRIVATE_PATH, '$1"[redacted-path]"')
    .replace(SINGLE_QUOTED_PRIVATE_PATH, "$1'[redacted-path]'")
