...
async function uninstallTask() {
  ...
  const result = await runPowerShell(`Unregister-ScheduledTask -TaskName '${WINDOWS_AGENT_TASK_NAME}' -Confirm:$false -ErrorAction SilentlyContinue`, 30000);
