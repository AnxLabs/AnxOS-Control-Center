!macro customInstall
  ...
  Pop $3
  ${If} $0 != 0
    MessageBox MB_ICONEXCLAMATION "AnxOS Control Center was installed, but the Local Agent could not be confirmed started (code $0).$\r$\n$\r$\nLaunch AnxOS Control Center from the Start menu, open Agent Control, and select Stop Old Local Agent and Repair in the Lifecycle section. You can also re-run this installer."
    Abort
  ${EndIf}
!macroend
